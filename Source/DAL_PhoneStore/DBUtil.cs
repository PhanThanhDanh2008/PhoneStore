...
namespace DAL_PhoneStore
{
    public class DBUtil
    {
        public static string connString = @"Data Source=LAPTOP-FU9P8L2M\SQLEXPRESS01;Initial Catalog=PhoneStore;Integrated Security=True;TrustServerCertificate=True";
